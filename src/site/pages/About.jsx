    ...
    <div className="about">
      <header className="mission section-separation container">
        ...
        <p className="mission__description">
          Proveer las soluciones más confiables e innovadoras de tecnologías de
          información, seguridad informática y telecomunicaciones, para mejorar
          la experiencia y productividad de nuestros clientes empresariales y
          gubernamentales.
        </p>
      </header>
      <section className="description section-separation">
        <div className="container">
          <h2 className="heading__secondary heading__secondary--white">
            Empresa Mexicana con +13 años de experiencia
          </h2>
          <p className="description__connection">
            Easy <span>Connection</span>
          </p>
          ...
          <div className="description__grid">
            ...
            <div className="description__text">
              <p>
                ...
                telecomunicaciones para las principales empresas de Ciudad de
                México.
              </p>

              <p>
                Tenemos la flexibilidad para entender las actividades y
                necesidades del cliente con soluciones que excedan sus
                expectativas, por eso hacemos que nuestros aliados reduzcan los
                costos de sus facturas.
              </p>

              <p>
                El cliente, como eje de nuestro negocio, nos permite tener una
                atención permanente y personalizada integrada en todos nuestros
                servicios.
              </p>
            </div>
          </div>
          ...
          <div className="value ">
            ...
            <div className="value__text">
              <h2 className="value__heading">
                Conectividad y tecnología superior
              </h2>
      ...
      <section className="banner banner--about">
        <p className="banner__text">
          Atención permanente y personalizada <strong>SIN COSTO</strong>
        </p>
      </section>
    </div>
  );
